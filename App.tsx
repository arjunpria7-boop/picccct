...
const App: React.FC = () => {
  ...
  const handleGenerate = useCallback(async () => {
    if (!currentImage || !prompt.trim() || !editHotspot) {
      setError(!currentImage ? 'No image loaded to edit.' : !editHotspot ? 'Please click on the image to select an area to edit.' : 'Please enter a description for your edit.');
      return;
    }
